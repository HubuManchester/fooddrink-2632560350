...
public partial class RegionPieChart : ContentView
{
    ...
    {
        ("Sichuan", new SKColor(0xE5, 0x39, 0x35)),
        ("Cantonese", new SKColor(0xFF, 0x98, 0x00)),
        ("Jiangnan", new SKColor(0x4C, 0xAF, 0x50)),
        ("Northern", new SKColor(0x21, 0x96, 0xF3)),
        ("Northwest", new SKColor(0x8D, 0x6E, 0x63)),
        ("Japan", new SKColor(0xE9, 0x1E, 0x63)),
        ("Korea", new SKColor(0x9C, 0x27, 0xB0)),
        ("SoutheastAsia", new SKColor(0xFF, 0xC1, 0x07)),
        ("Western", new SKColor(0x00, 0xBC, 0xD4)),
    };
