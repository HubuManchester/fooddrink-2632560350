...
public class DataSeedService
{
    ...
    private async Task SeedWishItemsAsync()
    {
        var items = new[]
        {
            new WishItem { FoodName = "云南过桥米线", Priority = "尽快", IsCompleted = false, CreatedAt = DateTime.Now.AddDays(-5).ToString("yyyy-MM-dd HH:mm:ss") },
            new WishItem { FoodName = "北京涮羊肉", Priority = "有空就去", IsCompleted = false, CreatedAt = DateTime.Now.AddDays(-4).ToString("yyyy-MM-dd HH:mm:ss") },
            new WishItem { FoodName = "广州白切鸡", Priority = "尽快", IsCompleted = true, CreatedAt = DateTime.Now.AddDays(-3).ToString("yyyy-MM-dd HH:mm:ss") },
            new WishItem { FoodName = "湖南臭豆腐", Priority = "随缘", IsCompleted = false, CreatedAt = DateTime.Now.AddDays(-2).ToString("yyyy-MM-dd HH:mm:ss") },
            new WishItem { FoodName = "兰州手抓羊肉", Priority = "有空就去", IsCompleted = false, CreatedAt = DateTime.Now.AddDays(-1).ToString("yyyy-MM-dd HH:mm:ss") },
            new WishItem { FoodName = "西班牙海鲜饭", Priority = "随缘", IsCompleted = false, CreatedAt = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") },
            new WishItem { FoodName = "日本和牛", Priority = "尽快", IsCompleted = false, CreatedAt = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") },
            new WishItem { FoodName = "成都兔头", Priority = "有空就去", IsCompleted = true, CreatedAt = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") },
        };
