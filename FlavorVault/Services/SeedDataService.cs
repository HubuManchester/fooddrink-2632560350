    ...
    private async Task SeedWishItemsAsync()
    {
        var items = new List<WishItem>
        {
            ...
            new()
            {
                ...
                Region = "韩国",
                Priority = "随缘",
                SourceReason = "想尝尝韩式火锅",
                IsCompleted = false,
                CreatedAt = "2025-05-20 10:20:00"
            },
            new()
            {
                FoodName = "凯旋门可丽饼",
